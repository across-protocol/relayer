...
import { deploySpokePoolWithToken, destinationChainId, deployAcrossConfigStore, getLastBlockTime, expect } from "./utils";
...
let hubPool: Contract, l1Token: Contract, acrossConfigStore: Contract;
