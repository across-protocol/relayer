...
export class MockSpokePoolClient extends clients.mocks.MockSpokePoolClient {
  ...
  relayerRefundExecutions: RelayerRefundExecutionWithBlock[] = [];
  ...
  setRelayerRefundExecutions(executions: RelayerRefundExecutionWithBlock[]): void {
    this.relayerRefundExecutions = executions;
  }

  getRelayerRefundExecutions(): RelayerRefundExecutionWithBlock[] {
    return this.relayerRefundExecutions.length > 0
      ? this.relayerRefundExecutions
      : super.getRelayerRefundExecutions();
  }
