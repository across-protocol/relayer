...
import { bnZero, bnOne, bnUint256Max, getNetworkName, getAllUnfilledDeposits, getMessageHash, EvmAddress, SvmAddress } from "../src/utils";
...
describe("Relayer: Check for Unfilled Deposits and Fill", async function () {
  ...
  beforeEach(async function () {
    ...
    tokenClient = new SimpleMockTokenClient(spyLogger, EvmAddress.from(relayer.address), SvmAddress.from("86ZyCV5E9XRYucpvQX8jupXveGyDLpnbmi8v5ixpXCrT", "base58"), spokePoolClients, hubPoolClient);
