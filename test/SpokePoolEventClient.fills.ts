...
import { originChainId, deploySpokePoolWithTokenAndEnable, fillRelay, destinationChainId } from "./utils";
...
describe("SpokePoolEventClient: Fills", async function () {
  beforeEach(async function () {
    ...
    ({ spokePool, erc20, destErc20, weth } = await deploySpokePoolWithTokenAndEnable(originChainId, destinationChainId));
