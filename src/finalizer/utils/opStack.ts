...
export async function opStackFinalizer(
  ...
  // (e.g. USDC.e on Worldchain, etc) so the easiest way to query for these events is to use the
  // TokenBridged event emitted by the Across SpokePool on every withdrawal.
