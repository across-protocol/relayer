...
export const IGNORED_SPOKE_BUNDLES = {
  1: [107, 104, 101, 96, 89, 83, 79, 78, 75, 74, 23, 2],
  10: [108, 105, 104, 101, 96, 89, 83, 79, 78, 75, 74, 23, 2],
  137: [107, 105, 104, 101, 96, 89, 83, 79, 78, 75, 74, 23, 2],
  288: [96, 93, 90, 85, 78, 72, 68, 67, 65, 2],
  42161: [107, 105, 104, 101, 96, 89, 83, 79, 78, 75, 74, 23, 2],
};
