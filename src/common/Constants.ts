...
export const multicall3Addresses = {
  ...
  919: "0x0000000000000000000000000000000000000000", // Multicall3 has no deployment on mode-sepolia
...
export const SLOW_WITHDRAWAL_CHAINS = [CHAIN_IDs.BASE, CHAIN_IDs.ARBITRUM, CHAIN_IDs.OPTIMISM, CHAIN_IDs.MODE];
