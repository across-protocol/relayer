  ...
  computeOutstandingCrossChainTransfers(l1Tokens: string[]): { [l1Token: string]: BigNumber } {
    ...
    for (const l1Token of l1Tokens) {
      ...
      const newestInitializedDeposit =
        this.l1DepositInitiatedEvents[l1Token][this.l1DepositInitiatedEvents[l1Token].length - 1];
      ...
      // the L2 events are searched over is ~1 day of events, with a safety buffer l2LooBackSafetyMargin(x3). As long as
      ...
      // this would be the case if this was the first deposit in ~1day*l2LooBackSafetyMargin blocks on the L2.
      ...
      let l1EventsToConsider = this.l1DepositInitiatedEvents[l1Token].slice(associatedL1DepositIndex + 1);
